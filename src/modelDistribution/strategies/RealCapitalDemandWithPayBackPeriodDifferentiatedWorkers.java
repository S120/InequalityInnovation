...
public class RealCapitalDemandWithPayBackPeriodDifferentiatedWorkers extends AbstractStrategy
	...
	public double computeRealCapitalDemand(MacroAgent seller) {
		ConsumptionFirmWithHierarchy investor= (ConsumptionFirmWithHierarchy) this.getAgent();
		CapitalGood newCapital= (CapitalGood)seller.getItemStockMatrix(true, productionStockId);
		double laborProductivityNew=newCapital.getProductivity()*newCapital.getCapitalLaborRatio()/((investor.getShareWorkers()+investor.getShareManagers()+investor.getShareTopManagers())/investor.getShareWorkers());
		...
		for (Item i:capitalStock){
			...
			double laborProductivityOld=oldCapital.getProductivity()*oldCapital.getCapitalLaborRatio()/((investor.getShareWorkers()+investor.getShareManagers()+investor.getShareTopManagers())/investor.getShareWorkers());
