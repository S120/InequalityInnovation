...
public class IncomeWealthProgressiveTaxStrategyWithDeficitManagement extends AbstractStrategy implements TaxPayerStrategyWithDeficitManagement {
	...
	public double computeTaxes(MacroAgent government) {
		...
		double incomeRedistributionFactorWorkers=workerShareIncome/Math.pow(workersSharePopulation,progressivenessExponent);
		double incomeRedistributionFactorManagers=managerResearcherShareIncome/Math.pow(managersResearchersSharePopulation,progressivenessExponent);
		double incomeRedistributionFactorTopManagers=topManagerShareIncome/Math.pow(topManagersSharePopulation, progressivenessExponent);
		double wealthRedistributionFactorWorkers=workerShareWealth/Math.pow(workersSharePopulation,progressivenessExponent);
		double wealthRedistributionFactorManagers=managerResearcherShareWealth/Math.pow(managersResearchersSharePopulation,progressivenessExponent);
		double wealthRedistributionFactorTopManagers=topManagerShareWealth/Math.pow(topManagersSharePopulation, progressivenessExponent);
