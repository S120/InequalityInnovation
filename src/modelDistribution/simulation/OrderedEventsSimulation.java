 ...
 */
package modelDistribution.simulation;
...
//			}
			...
			if(event instanceof MacroVariableTicEvent){
				...
				if ((varEvent.getTic()==StaticValues.TIC_WORKERSNETINCOMEREPORT)||(varEvent.getTic()==StaticValues.TIC_MANAGERSNETINCOMEREPORT)||(varEvent.getTic()==StaticValues.TIC_TOPMANAGERSNETINCOMEREPORT)||(varEvent.getTic()==StaticValues.TIC_RESEARCHERSNETINCOMEREPORT)
						|| (varEvent.getTic()==StaticValues.TIC_WORKERSDEPOSITSREPORT) || (varEvent.getTic()==StaticValues.TIC_MANAGERSDEPOSITSREPORT)||(varEvent.getTic()==StaticValues.TIC_TOPMANAGERSDEPOSITSREPORT)||(varEvent.getTic()==StaticValues.TIC_RESEARCHERSDEPOSITSREPORT) 
						|| (varEvent.getTic()==StaticValues.TIC_WORKERSWAGEREPORT) || (varEvent.getTic()==StaticValues.TIC_MANAGERSWAGEREPORT)||(varEvent.getTic()==StaticValues.TIC_TOPMANAGERSDEPOSITSREPORT)||(varEvent.getTic()==StaticValues.TIC_RESEARCHERSDEPOSITSREPORT)){
					if ((this.getRound() % 40==0) || this.getRound()==1){
