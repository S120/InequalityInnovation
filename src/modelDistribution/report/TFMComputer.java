...
import modelDistribution.strategies.FixedShareOfProfitsToPopulationAsShareOfWealthDividends;
...
public class TFMComputer extends AbstractMicroComputer implements
	...
	public Map<Long, Double> computeVariables(MacroSimulation sim) {
		...
		for (Agent i:hhpop.getAgents()){
			HouseholdsDifferentiated hh= (HouseholdsDifferentiated) i;
			if (!hh.isDead()){				
		...
		GovernmentDifferentiatedWorkers gov = (GovernmentDifferentiatedWorkers) gpop.getAgentList().get(0);
		wG = gov.getWageBill();
