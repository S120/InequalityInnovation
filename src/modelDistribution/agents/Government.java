...
public class Government extends SimpleAbstractAgent implements LaborDemander, BondSupplier{
	...
	protected double taxRatesMultiplyingFactor;
...
//		double taxesRevenues=0;
	...
	/**
	 * @return the taxRatesMultiplyingFactor
	 */
	public double getTaxRatesMultiplyingFactor() {
		return taxRatesMultiplyingFactor;
	}

	/**
	 * @param taxRatesMultiplyingFactor the taxRatesMultiplyingFactor to set
	 */
	public void setTaxRatesMultiplyingFactor(double taxRatesMultiplyingFactor) {
		this.taxRatesMultiplyingFactor = taxRatesMultiplyingFactor;
	}
