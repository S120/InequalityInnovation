...
public class ConsumptionFirmWithHierarchy extends ConsumptionFirm implements GoodSupplier, GoodDemander, CreditDemander, 
LaborDemanderDifferentiatedWorkers, DepositDemander, PriceSetterWithTargets, ProfitsTaxPayer, FinanceAgent, InvestmentAgent {
	...
	public ConsumptionFirmWithHierarchy() {
		super();
