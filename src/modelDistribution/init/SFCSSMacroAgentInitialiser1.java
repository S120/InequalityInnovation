 ...
 *
 */
public class SFCSSMacroAgentInitialiser1 extends AbstractMacroAgentInitialiser implements MacroAgentInitialiser{
	...
	public void initialise(MacroPopulation population, MacroSimulation sim) {
		...
		HouseholdsDifferentiated h = (HouseholdsDifferentiated) workers.getAgentList().get(0);
